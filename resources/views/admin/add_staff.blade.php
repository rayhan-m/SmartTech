                        ...
                        @csrf
                         <div class="row">
                                ...
                                <div class="white-box">
                                    ...
                                    <div class="col-lg-3">
                                        <div class="input-effect">
                                            ...
                                            <input class="primary-input form-control{{ $errors->has('mobile') ? ' is-invalid' : '' }}" type="text" onkeyup="isNumberKeyDecimal(this);"   name="mobile" value="{{isset($editData)? @$editData->mobile : '' }}">
                                            <span class="focus-border"></span>
                                    ...
                                    <div class="col-lg-3">
                                        <div class="input-effect">
                                            ...
                                            <input class="primary-input form-control{{ $errors->has('emergency_mobile') ? ' is-invalid' : '' }}" type="text" onkeyup="isNumberKeyDecimal(this);"   name="emergency_mobile" value="{{isset($editData)? @$editData->emergency_mobile : '' }}">
                                            <span class="focus-border"></span>
                                ...
                                <div class="col-lg-6  mt-20">
                                    @if (isset($editData))
                                        <img height="80px;" width="80px;"  src="{{asset('/')}}{{@$editData->staff_photo}}" class="img img-fluid">
                                    @endif
