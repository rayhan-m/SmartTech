                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($data as $item)
                                                <tr>
                                                    ...
                                                    <td>{{@$item->amount}}</td>
                                                    <td> 
                                                        <a class="btn btn-primary" href="{{asset('/')}}{{$item->voucher}}" target="_blank">View</a>
                                                    </td>
                                                    <td>{{@$item->details}}</td>
                                                    ...
                                                    <td> 
                                                      ...
                                                      <a data-toggle="modal" data-target="#deleteModal{{@$item->id}}"  href="#"><ion-icon name="trash-outline"></ion-icon></a>
                                                  </td>
                                                </tr>
                                                <!-- Edit Modal starts -->       
