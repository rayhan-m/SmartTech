            ...
            <div class="card-body col-md-6" style="margin-left:50px">
                ...
                <form method="POST" action="{{route('staff_payment_submit')}}" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input class="primary-input form-control{{ $errors->has('pay_amount') ? ' is-invalid' : '' }}" type="text" onkeyup="isNumberKeyDecimal(this);"  value="{{@$staffInfo->basic_salary}}" name="pay_amount" placeholder="Paid amount"autocomplete="off">
                            <span class="focus-border"></span>
