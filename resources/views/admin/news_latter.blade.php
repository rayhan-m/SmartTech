...
@section('mainContent')
    ...
    <div class="breadcrumb">
        <ul>
            <li><a href="#">News Latter</a></li>
        </ul>
    </div>
    <div class=" border-top"></div>
    <div class="mt-20 mb-20">
        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal"> <span>+</span> Subscriber</button>
    </div>
                                            ...
                                            @foreach ($data as $item)
                                                <tr>
                                                    ...
                                                    <td>@if (@$item->active_status==1)
                                                        <a href="{{ url('admin/news-latter-deactive/'.@$item->id)}}"> <label class="badge badge-info">Active</label></a>
                                                        @else
                                                          <a href="{{ url('admin/news-latter-active/'.@$item->id)}}"> <label class="badge badge-danger">Deactive</label></a>
                                                        @endif</td>
                                                ...
                                                <div class="modal fade" id="editModal{{@$item->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel-2" aria-hidden="true">
                                                  ...
                                                  <div class="modal-header">
                                                      <h5 class="modal-title" id="exampleModalLabel-2">Edit Subscriber</h5>
                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                        <span aria-hidden="true">&times;</span>
                                                      </button>
                                                    </div>
                                                    <form method="POST" action="{{url('admin/news-latter-update')}}" enctype="multipart/form-data">
                                                      @csrf 
                                                          ...
                                                          <div class="col-lg-10 col-lg-offset-1">
                                                              <div class="input-effect">
                                                                <label>Email</label>
                                                                  ...
                                                                  <input class="primary-input form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" type="text" name="email" placeholder="Email" value="{{ @$item->email}}" autocomplete="off">
                  ...
                  <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel-2" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                      <div class="modal-content">
                        ...
                        <form method="POST" action="{{route('news_latter_submit')}}" enctype="multipart/form-data">
                          @csrf 
                          <div class="modal-body">
                            <div class="row mb-20">
                              <div class="col-lg-10 col-lg-offset-1">
                                  <div class="input-effect">
                                    <label>Email</label>
                                      <input class="primary-input form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" type="email" name="email" placeholder="Email" required autocomplete="off">
                                      <span class="focus-border"></span> @if ($errors->has('email'))
                                      <span class="invalid-feedback" role="alert">
                                    <strong>{{ $errors->first('email') }}</strong>
                                </span> @endif
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="text-center">
                                    <h4>Are You Sure To Delete Subscriber ?</h4>
                                </div>
                                ...
                                <div class="mt-20 d-flex justify-content-between">
                                    ...
                                    <form action="{{url('admin/news-latter-delete/'.@$item->id)}}" method="DELETE" enctype="multipart/form-data"
                                      >
